      ...
      <div className="md:flex justify-between lg:px-20 py-10 px-2">
        ...
        <div className="lg:w-[50%] lg:px-5 px-2 text-justify py-5">
          <p>
            ...
            Quam doloremque, iste est quibusdam assumenda debitis recusandae,
            fuga dignissimos quos ab excepturi. Voluptatum explicabo consectetur
            ...
            aperiam maiores nobis quam. Eligendi debitis, esse natus quidem
            ullam recusandae fugit?
          </p>
        </div>
      </div>
    </div>
